...
Public Class Subir_Calificaciones
    Private Sub Label1_Click(sender As Object, e As EventArgs) Handles Label1.Click

    End Sub

    Private Sub Label2_Click(sender As Object, e As EventArgs) Handles lblGrupo.Click
    ...
    Private Sub Subir_Calificaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        lstCarrera.BackColor = Color.White
        lstGrupo.Enabled = False
        lstGrupo.BackColor = Color.LightGray
        datagCalificaciones.Enabled = False
        datagCalificaciones.BackgroundColor = Color.LightGray
        lstAlumno.Enabled = False
        lstAlumno.BackColor = Color.LightGray
            ...
            Using con As New Data.OleDb.OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Sistema.mdb")
                ...
                Using cmdSelect As New OleDbCommand(consulta, con)
                    ...
                    Else
                        ...
                        Dim seleccion As Integer = MsgBox("Carrera sin grupos registrados", MsgBoxStyle.Information)
            ...
            Using con As New Data.OleDb.OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Sistema.mdb")
                ...
                Using cmdSelect As New OleDbCommand(consulta, con)
                    ...
                    If dtrReader.HasRows Then
                        ...
                        Loop
                        lstCarrera.Enabled = False
                        lstCarrera.BackColor = Color.LightGray
                        lstGrupo.Enabled = True
                        lstGrupo.BackColor = Color.White
                        datagCalificaciones.Enabled = False
                        datagCalificaciones.BackgroundColor = Color.LightGray
            ...
            Using con As New Data.OleDb.OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Sistema.mdb")
                ...
                Using cmdSelect As New OleDbCommand(consulta, con)
                    ...
                    If dtrReader.HasRows Then
                        ...
                        datagCalificaciones.Enabled = False
                        datagCalificaciones.BackgroundColor = Color.LightGray
                        lstAlumno.Enabled = True
                        lstAlumno.BackColor = Color.White
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        MsgBox("Calificación guardada con éxito")
