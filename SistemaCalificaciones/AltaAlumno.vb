...
Public Class AltaAlumno
    ...
    Private Sub Desactivar_Captura()
        ...
        txtCarrera.BackColor = Color.LightSlateGray
            ...
            Using cmdSelect As New OleDbCommand(consulta, con)
                ...
                If dtrReader.HasRows Then
                    If dtrReader.Read() Then
                        ...
                        txtCarrera.Text = dtrReader("Carrera")
    ...
    Private Sub AltaAlumno_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        ...
        Try
            ...
            Using con As New Data.OleDb.OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Sistema.mdb")
                ...
                Using cmdSelect As New OleDbCommand(consulta, con)
                    ...
                    consultaAdd = "    INSERT INTO Alumno (Matricula,Nombre,ApellidoP,ApellidoM,Carrera,Contrasena) 
                            Select @IDMatricula AS Matricula, @IDNombre As Nombre, @IDApellidoP As ApellidoP, @IDApellidoM  As ApellidoM, @IDCarrera As Carrera, @IDContrasena As Contrasena
                        "
                    ...
                    Using conins As New Data.OleDb.OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Sistema.mdb")
                        ...
                        Using cmdInsert As New OleDbCommand(consultaAdd, conins)
                            ...
                            cmdInsert.Parameters("@IDCarrera").Value = txtCarrera.Text
                    ...
                    Dim actualizausuario As Boolean = Añade_usuario(txtMatricula.Text, txtContra.Text, "S")
